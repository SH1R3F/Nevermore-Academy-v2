...
class UserPolicy
{
     ...
     * @param  \App\Models\User|string  $controlled_user
     * @return void|bool
     */
    public function before(User $user, $ability, $controlled_user)
    {
        // Superadmins cannot be deleted
        if ($ability === 'delete' && $controlled_user->hasRole('superadmin')) return false;
