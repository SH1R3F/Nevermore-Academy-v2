...
@section('title', 'Verify your mobile')
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                        <div class="card card-plain">
                            <div class="card-header pb-0 text-start">
                                <h4 class="font-weight-bolder">Verify your mobile</h4>
                                <p class="mb-0">Enter the code that's sent to your mobile phone</p>
                            </div>
                            ...
                            <div class="card-body">
                                <form role="form" method="POST" action="{{ route('verify-mobile.verify') }}">
                                    @csrf
                                    <div class="mb-3">
                            ...
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-4 text-sm mx-auto">
                                    ...
                                    <a href="{{ route('verify-mobile.resend') }}"
