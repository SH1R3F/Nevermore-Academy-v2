<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
            <img src="{{ auth()->user()->getFirstMediaUrl('images') ?:asset('assets/img/logo.webp') }}"
    ...
    <div class="collapse navbar-collapse h-auto w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @role('superadmin')
                <li class="nav-item">
                    <a class="nav-link{{ request()->routeIs('notifications.create') ? ' active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Create a notification</span>
                    </a>
                </li>
            @endrole
            ...
            @can('viewAny', 'App\Models\Submission')
                <li class="nav-item">
